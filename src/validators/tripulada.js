...
const validatorCreateNaveTripulada = [
  check('nombre')
    .exists()
    .notEmpty()
    .isString(),
  ...
  (req, res, next) => {
    try {
      ...
      res.status(400);
      res.send({ errors: error.array(), message: 'validation new nave tripulada' });
    }
  }
]
...
module.exports = { validatorCreateNaveTripulada, validatorGetNave, validatorGetNaveByName };